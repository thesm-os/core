...
func TestFixedSentinelErrors(t *testing.T) {
	t.Parallel()
	...
	all := []errEntry{
		{"ErrDivZero", fixed.ErrDivZero},
		{"ErrOverflow", fixed.ErrOverflow},
		{"ErrPrecision", fixed.ErrPrecision},
		{"ErrRange", fixed.ErrRange},
		{"ErrSize", fixed.ErrSize},
		{"ErrSyntax", fixed.ErrSyntax},
	}
