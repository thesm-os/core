...
func TestEd25519SentinelErrors(t *testing.T) {
	t.Parallel()
	...
	all := []errEntry{
		{"ErrInvalidPrivateKeySize", ed25519.ErrInvalidPrivateKeySize},
		{"ErrInvalidPublicKeySize", ed25519.ErrInvalidPublicKeySize},
	}
