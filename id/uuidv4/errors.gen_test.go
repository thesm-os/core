...
func TestUuidv4SentinelErrors(t *testing.T) {
	t.Parallel()
	...
	all := []errEntry{
		{"ErrInvalidChar", uuidv4.ErrInvalidChar},
		{"ErrInvalidFormat", uuidv4.ErrInvalidFormat},
		{"ErrInvalidLength", uuidv4.ErrInvalidLength},
	}
