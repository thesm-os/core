...
func TestUlidSentinelErrors(t *testing.T) {
	t.Parallel()
	...
	all := []errEntry{
		{"ErrInvalidChar", ulid.ErrInvalidChar},
		{"ErrInvalidLength", ulid.ErrInvalidLength},
		{"ErrInvalidTimestamp", ulid.ErrInvalidTimestamp},
	}
